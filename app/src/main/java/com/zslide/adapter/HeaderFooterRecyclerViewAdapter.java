...
public abstract class HeaderFooterRecyclerViewAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
     ...
     * @return the view SettingItemAdapter.
     */
     ...
     *
     * @param headerViewHolder the view SettingItemAdapter for the header item.
     * @param position         the position.
     */
     ...
     *
     * @param footerViewHolder the view SettingItemAdapter for the footer item.
     * @param position         the position.
     */
     ...
     *
     * @param contentViewHolder the view SettingItemAdapter for the content item.
     * @param position          the position.
     */
